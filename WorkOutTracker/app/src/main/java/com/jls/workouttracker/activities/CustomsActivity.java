...
public class CustomsActivity extends AppCompatActivity implements NewDialog.newDialogListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRef = FirebaseDatabase.getInstance().getReference("user").child(fAuth.getUid()).child("wcustoms");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        MenuItem item = menu.findItem(R.id.op_custom_w);
        item.setVisible(false);
        item = menu.findItem(R.id.op_pwork);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.op_signout:
                fAuth.signOut();
                Toast.makeText(CustomsActivity.this, "Logged out", Toast.LENGTH_SHORT).show();
                finish();
                break;
            case R.id.op_pwork:
                Intent intent = new Intent(CustomsActivity.this, WorksListActivity.class);
